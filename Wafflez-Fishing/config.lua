...
Config.Framework = 'qb' -- 'qb' QBCORE | 'qbx' QBOX

Config.Notify = 'ox' -- 'ox' Ox_Lib | 'qb' qb-notify
...
Config.PedData = {
    ...
    target = {
        label = "Speak with Fisherman",
        icon = "fa-solid fa-comment"
    },

    blip = {                -- BLIP TO SPEAK TO THE FISHERMAN
        enabled = true,
        size = 1.0,
        sprite = 762,
        color = 0,
...
--------------NO TOUCHING BELOW PLS THANK YOU---------------------------------------------------------------------------------------------------------------
